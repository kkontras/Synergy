#!/usr/bin/env python3
"""
Download CMU-MOSI prepared artifact used by MultiBench/FactorCL affect loader.

This script downloads a prebuilt data file from Google Drive and stores it
under a dataset-specific directory.
"""
...
DATASET_NAME = "mosi"
DEFAULT_GDRIVE_FILE_ID = "1_XdzdW8UNG1TTS6QcX10uhoS6N11OBit"
DEFAULT_FILENAME = "mosi_data.pkl"
...
def build_arg_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Download MOSI prepared artifact for FactorCL dataloader.")
...
def main() -> None:
    ...
    print(f"[mosi] ready: {output_path}")
    print(f"[mosi] set config.dataset.data_roots={output_path}")
