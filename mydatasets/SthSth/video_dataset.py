...
from mydatasets.SthSth.dataset_proto import ProtoDataset
from mydatasets.SthSth.utils_data import compile_transforms, get_video_transforms
from mydatasets.SthSth.sampler import get_sampler
...
class VideoDataset(ProtoDataset):
    ...
    def __getitem__(self, idx: int):
        ...
        # Pass indices to the output object, so that the other mydatasets can use it
