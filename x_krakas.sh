...
CUDA_VISIBLE_DEVICES=6,7 accelerate launch \
    ...
    train.py \
    --config ./configs/ScienceQA/synprom_lora_synibfaster.json \
    --default_config ./configs/ScienceQA/default_config_scienceqa_syn_mib.json \
...
accelerate launch \
    --mixed_precision bf16 \
    train.py \
    --config ./configs/ScienceQA/synprom_lora.json  --default_config ./configs/ScienceQA/default_config_scienceqa_syn.json --fold 0 --lr 0.001 --wd 0.001 --batch_size 8
