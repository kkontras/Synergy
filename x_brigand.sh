...
#  python show.py --config ./configs/CREMA_D/synergy/jan/unimodal_video.json --default_config ./configs/CREMA_D/default_config_cremadplus_res_syn.json --fold 0 --lr 0.0001 --wd 0.0001 --batch_size 64  --cls mlp --ironic_rate $ir
  python show.py --config ./configs/CREMA_D/synergy/jan/ens.json --default_config ./configs/CREMA_D/default_config_cremadplus_res_syn.json --fold $fold --lr 0.0001 --wd 0.0001 --cls mlp --batch_size 64 --ironic_rate $ir
#  python train.py --config ./configs/CREMA_D/synergy/jan/synprom_RMask.json --default_config ./configs/CREMA_D/default_config_cremadplus_res_syn.json --fold $fold --l 0 --lr 0.0001 --wd 0.0001 --cls mlp --batch_size 64 --ironic_rate $ir
