...
def print_search(config_path, default_config_path, args):
    ...
    if "weight1" in args and args.weight1 is not None:
        m += "_w1{}".format(args.weight1)
    if "weight2" in args and args.weight2 is not None:
        m += "_w2{}".format(args.weight2)
    ...
    if "ceb_mode" in args and args.ceb_mode is not None:
        m += "_ceb{}".format(args.ceb_mode)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--ceb_mode', help="ceb mode label or pred?")
    ...
    parser.add_argument('--weight1', help="ReconBoost Parameters")
    parser.add_argument('--weight2', help="ReconBoost Parameters")
