...
python train.py --config ./configs/CREMA_D/synergy/jan/synprom_RMask.json --default_config ./configs/CREMA_D/default_config_cremadplus_res_syn.json --fold 0 --l 0 --lr 0.00001 --wd 0.0001 --cls mlp --batch_size 64 --validate_with syn_accuracy
python train.py --config ./configs/CREMA_D/synergy/jan/synprom_RMask.json --default_config ./configs/CREMA_D/default_config_cremadplus_res_syn.json --fold 0 --l 1 --lr 0.00001 --wd 0.0001 --cls mlp --batch_size 64 --perturb_fill ema --perturb_lsparse 1
python train.py --config ./configs/CREMA_D/synergy/jan/synprom_RMask.json --default_config ./configs/CREMA_D/default_config_cremadplus_res_syn.json --fold 0 --l 0.1 --lr 0.00001 --wd 0.0001 --cls mlp --batch_size 64 --perturb_fill ema --perturb_lsparse 1
python train.py --config ./configs/CREMA_D/synergy/jan/synprom_RMask.json --default_config ./configs/CREMA_D/default_config_cremadplus_res_syn.json --fold 0 --l 1 --lr 0.00001 --wd 0.0001 --cls mlp --batch_size 64 --perturb_fill ema --perturb_lsparse 1 --validate_with syn_accuracy
python train.py --config ./configs/CREMA_D/synergy/jan/synprom_RMask.json --default_config ./configs/CREMA_D/default_config_cremadplus_res_syn.json --fold 0 --l 0.1 --lr 0.00001 --wd 0.0001 --cls mlp --batch_size 64 --perturb_fill ema --perturb_lsparse 1 --validate_with syn_accuracy
