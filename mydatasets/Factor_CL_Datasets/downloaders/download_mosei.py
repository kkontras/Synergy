#!/usr/bin/env python3
"""
Download CMU-MOSEI prepared artifact used by MultiBench/FactorCL affect loader.
"""
...
DATASET_NAME = "mosei"
DEFAULT_GDRIVE_FILE_ID = "180l4pN6XAv8-OAYQ6OrMheFUMwtqUWbz"
DEFAULT_FILENAME = "mosei_data.pkl"
...
def build_arg_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Download MOSEI prepared artifact for FactorCL dataloader.")
...
def main() -> None:
    ...
    print(f"[mosei] ready: {output_path}")
    print(f"[mosei] set config.dataset.data_roots={output_path}")
