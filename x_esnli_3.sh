...
CUDA_VISIBLE_DEVICES=4 python mydatasets/ESNLI/ESNLI_CodeBook_v2.py --split validation --data_root "/scratch/kkontras/ESNLI" --model_name "Qwen/Qwen3-VL-2B-Instruct" --out_dir "/scratch/kkontras/ESNLI/cache_qwen3_vl_2b_nocls_vis" --batch_size 128
