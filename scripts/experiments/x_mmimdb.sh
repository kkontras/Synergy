...
for lr in 0.001 0.0001 0.00001; do
  for wd in 0.001 0.0001 0.00001; do
    python scripts/entrypoints/show.py --config ./configs/MMIMDB/unimodal_text.json --default_config ./configs/MMIMDB/default_config_mmimdb_syn.json --fold $fold --lr $lr --wd $wd --batch_size 32
    python scripts/entrypoints/show.py --config ./configs/MMIMDB/unimodal_vision.json --default_config ./configs/MMIMDB/default_config_mmimdb_syn.json --fold $fold --lr $lr --wd $wd --batch_size 32
done
done
done

python scripts/entrypoints/show.py --config ./configs/MMIMDB/unimodal_text.json --default_config ./configs/MMIMDB/default_config_mmimdb_syn.json --fold 0 --lr 0.0001 --wd 0.0001 --batch_size 32
python scripts/entrypoints/show.py --config ./configs/MMIMDB/unimodal_vision.json --default_config ./configs/MMIMDB/default_config_mmimdb_syn.json --fold 0 --lr 0.0001 --wd 0.0001 --batch_size 32
