#!/usr/bin/env python3
"""
Download MUStARD prepared artifact used by MultiBench/FactorCL affect loader.
"""
...
DEFAULT_GDRIVE_FILE_ID = "1EMBUmUL5B0PTncGx3L-sBElGOmjFBR_h"
DEFAULT_FILENAME = "mustard_data.pkl"
...
def build_arg_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Download MUStARD prepared artifact for FactorCL dataloader.")
...
def main() -> None:
    ...
    print(f"[mustard] ready: {output_path}")
    print(f"[mustard] set config.dataset.data_roots={output_path}")
    print("[mustard] use config.dataset.data_type=sarcasm for current get_data.py logic.")
