...
echo "Job finished"
  ...
  CUDA_VISIBLE_DEVICES=0 python scripts/entrypoints/train.py --config         ./configs/ESNLI/smoke_image_lora.json    --default_config ./configs/ESNLI/default_config_esnli_smoke.json    --fold 0 --lr 0.0001 --wd 0.00001 --batch_size 2 --tdqm_disable  